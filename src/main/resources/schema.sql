...
alter table chat_rooms add constraint FK1jfw80jldnwqbnm098kowzxdb foreign key (todo_id) references todos;
alter table messages add constraint FKfpfw90134nwqbnm098kowzmsg foreign key (chatroom_id) references chat_rooms;